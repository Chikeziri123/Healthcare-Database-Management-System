...
(1, 'Samuel', 'Adeyemi', '1990-05-15', 'Male', '123 Main St, Cityville'),
(2, 'Amara', 'Okafor', '1985-08-22', 'Female', '456 Oak St, Townsville'),
(3, 'Priya', 'Ramanathan', '1972-12-03', 'Female', '789 Pine St, Villagetown'),
(4, 'Bob', 'Williams', '1988-07-19', 'Male', '101 Cedar St, Hamletsville'),
(5, 'Hannah', 'Davis', '1995-03-28', 'Female', '222 Maple St, Riverside'),
(6, 'Luca', 'Moretti', '1979-09-10', 'Male', '333 Elm St, Hillside'),
(7, 'Sophia', 'Miller', '1965-02-14', 'Female', '444 Birch St, Lakeside'),
(8, 'David', 'Jones', '1993-11-07', 'Male', '555 Oak St, Countryside'),
(9, 'Olivia', 'Cortes', '1980-06-25', 'Female', '666 Cedar St, Summitville'),
(10, 'Kwame', 'Mensah', '1970-04-18', 'Male', '777 Pine St, Brookside');
...
VALUES
(1, 1, 1, '2025-01-10', 'Antibiotics', 'None'),
(2, 2, 2, '2014-12-01', 'Anti-hypertensive medication', 'None'),
(3, 3, 3, '2025-02-05', 'Antihistamines', 'None'),
(4, 4, 4, '2024-11-05', 'Levothyroxine', 'Physical therapy for knee'),
(5, 5, 5, '2025-01-20', 'Sumatriptan', 'Lifestyle modifications'),
(6, 6, 6, '2024-12-10', 'Epinephrine auto-injector', 'Avoidance of allergens'),
(7, 7, 7, '2025-02-01', 'Epinephrine auto-injector', 'Avoidance of peanuts'),
(8, 8, 8, '2025-01-15', 'Avoidance of latex', 'None'),
(9, 9, 9, '2024-11-20', 'Proton pump inhibitors', 'None'),
(10, 10, 10, '2025-02-10', 'Avoidance of eggs', 'None');

SELECT * FROM Treatments;

-- Insert Sample Values into BillingInformation Table
INSERT INTO BillingInformation VALUES
(1, 1, '2025-01-10', 'CPT123', 'Insurance Company A', 150.00),
(2, 2, '2024-12-01', 'CPT456', 'Insurance Company B', 200.00),
(3, 3, '2025-02-15', 'CPT789', 'Insurance Company C', 120.00),
(4, 4, '2024-11-05', 'CPT101', 'Insurance Company A', 180.00),
(5, 5, '2025-01-20', 'CPT222', 'Insurance Company B', 250.00),
(6, 6, '2024-12-10', 'CPT333', 'Insurance Company C', 90.00),
(7, 7, '2025-02-05', 'CPT444', 'Insurance Company A', 200.00),
(8, 8, '2025-01-15', 'CPT555', 'Insurance Company B', 170.00),
(9, 9, '2024-11-20', 'CPT666', 'Insurance Company C', 120.00),
(10, 10, '2025-02-10', 'CPT777', 'Insurance Company A', 220.00);
...
(1, 1, '2025-02-01 09:00:00', 'Dr. Smith', 'Routine Check-up'),
(2, 2, '2025-02-15 14:30:00', 'Dr. Brown', 'Follow-up'),
(3, 3, '2025-03-05 10:45:00', 'Dr. Taylor', 'Follow-up'),
(4, 4, '2025-01-20 11:30:00', 'Dr. Martinez', 'Routine Check-up'),
(5, 5, '2025-03-10 15:15:00', 'Dr. Harris', 'Follow-up'),
(6, 6, '2025-02-10 13:00:00', 'Dr. Turner', 'Routine Check-up'),
(7, 7, '2025-01-15 08:30:00', 'Dr. Rodriguez', 'Routine Check-up'),
(8, 8, '2025-03-01 12:00:00', 'Dr. Adams', 'Routine Check-up'),
(9, 9, '2025-01-25 09:45:00', 'Dr. White', 'Follow-up'),
(10, 10, '2025-02-20 14:00:00', 'Dr. Hall', 'Routine Check-up');

SELECT * FROM AppointmentScheduling;


-- Some Analysis to Uncover some Insights
